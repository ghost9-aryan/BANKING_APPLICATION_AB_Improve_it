...
def create_login():
    ...
    def log_in():
        ...
        account_number_ = account_number_entry.get()
        ...
        try:
            ...
            cursor.execute(query, (username_, account_number_))
            existing_record = cursor.fetchone()
            if existing_record:
                messagebox.showinfo('Data',existing_record)
                user_name_entry.set('')    
                account_number.set('')     
    ...
    username_entry_clear = tk.Button(LOGIN, text="Clear", command=clear1, font=("Arial", 10), bg='white', fg='black')
    ...
    account_number_entry = tk.Entry(LOGIN, font=("Arial",29), textvariable=account_number)
    account_number_entry.place(x=650,y=400)

    account_entry_clear = tk.Button(LOGIN, text="Clear", command=clear2, font=("Arial", 10), bg='white', fg='black')
